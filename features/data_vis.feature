Feature: Data visualization
    ...
    Scenario: Pie charts of student demographic
        ...
        And I should see these pie charts of student demographic: "F v. M Intl v. U.S. Years of experience Undergraduate Majors"

    Scenario: Organization tab
        When I am on the data visualization page
        And I click on "Organization" tab
        And I should see a bar chart of top 10 organizations in graduate number
